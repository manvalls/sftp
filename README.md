...
[![UNIX Build Status](https://travis-ci.org/pkg/sftp.svg?branch=master)](https://travis-ci.org/pkg/sftp) [![GoDoc](http://godoc.org/github.com/manvalls/sftp?status.svg)](http://godoc.org/github.com/manvalls/sftp)

usage and examples
------------------

See [godoc.org/github.com/manvalls/sftp](http://godoc.org/github.com/manvalls/sftp) for
examples and usage.
